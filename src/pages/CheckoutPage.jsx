...
import { deleteCartAsync, selectItem, updateCartAsync } from '../features/cart/cartSlice';
...
const CheckoutPage = () => {
  ...
  return (
    ...
    <div className="mx-auto bg-white mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold leading-7 p-4 text-gray-700 sm:truncate sm:text-3xl sm:tracking-tight">
          Cart
        </h2>
                  ...
                  <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 items-end justify-between text-sm">
                      <div className="text-gray-500">
                        ...
                        <select className="ml-3" onChange={(e)=>handelQuantity(e,item)} value={item.quantity}>
