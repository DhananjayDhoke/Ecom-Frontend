          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
           ...
           dispatch={dispatch}
            ...
            {/* pagination components start*/}
              <Pagination totalItem={totalItems} page={page} setPage={setPage} handelPage={handelPage}></Pagination>
            {/* pagination components end */}
          </main>
        </div>
      </div>
    </div>
...
function MobileFilter({filters,mobileFiltersOpen,setMobileFiltersOpen,subCategories}) {
...
function DesktopFilter({filters,filter,setFilter,dispatch,handelFilter,subCategories}) {
    ...
    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
      <div>
        <p className="text-sm text-gray-700">
          ...
          <span className="font-medium">{page*ITEM_PER_PAGE>totalItem?totalItem:page*ITEM_PER_PAGE}</span> of{" "}
